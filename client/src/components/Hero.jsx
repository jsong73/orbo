...
<section class="py-20 bg-white">
    <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        <div class="relative">
            <h2 class="w-full text-3xl font-bold text-center sm:text-4xl md:text-5xl"> Unlock Your Task Potential </h2>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-blue-500 uppercase">Drag-n-drop design</p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-blue-500 uppercase">know your data</p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-blue-500 uppercase">Easy to customize</p>
